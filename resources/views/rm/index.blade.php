...
<html lang="en">
<head>
<title>Rock Music an entertainment Category | Home</title>
...
<body>
					...
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header">
							...
							<div class="agileits-logo">
								<h1><a href="index.blade.php"><img src="images/logo1.png" alt="" /> Rock Music</a></h1>
							</div>
						</div>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home-main" aria-labelledby="home-tab">
							<div class="w3_tab_img">
								...
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="images/{{ $data['photo'] }}  ">
										  <figure class="imghvr-shutter-in-out-diag-2"><img src="images/{{ $data['photo'] }}" alt=" " class="img-responsive" />
										  </figure>
										</a>
									</div>
	...
	<footer>
		<div class="container">
			<p>© 2017 Rock Music . All Rights Reserved | Design by <a href="#"> Virtual Employee</a> </p>
		</div>
	</footer>
	<!-- //footer -->
