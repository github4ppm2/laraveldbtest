...
class Swift_Events_SimpleEventDispatcher implements Swift_Events_EventDispatcher
{
    ...
    /** Myevent listeners bound to this dispatcher */
    private $_listeners = array();

    /** Listeners queued to have an Myevent bubbled up the stack to them */
    ...
    /**
     * Dispatch the given Myevent to all suitable listeners.
     *
